import {
  ...
  BurnerAdded as BurnerAddedEvent,
  BurnerRemoved as BurnerRemovedEvent,
...
export function handleBurnerAdded(event: BurnerAddedEvent): void {
  let entity = new BurnerAdded(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
...
export function handleBurnerRemoved(event: BurnerRemovedEvent): void {
  let entity = new BurnerRemoved(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.account = event.params.account
